Types::ProjectType = GraphQL::ObjectType.define do
  ...
  field :milestones, !types.Int, description: 'Milestones accomplished in the project'
  ...
  field :technical_information, !types.Int, description: 'Project technical information'
end
